		...
		<nav class="navbar navbar-static-top" role="navigation">
			...
			<div class="navbar-right">
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        <a href="<?php echo base_url().'dashboard'; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-dashboard"></i><span> Dashboard</span></a>            
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo base_url().'dashboard'; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-folder"></i><span> File Manager</span></a>            
                    </li>                                       
